...
The 'dbt_with_udf_example' project was generated by using the dbt template for
...
3. Install dbt
   ...
   Run these instructions from the `dbt_with_udf_example` directory. We recommend making
...
`[dev yourname] dbt_with_udf_example_job` to your workspace.
...
When deploying to this target, note that the default job at resources/dbt_with_udf_example.job.yml
